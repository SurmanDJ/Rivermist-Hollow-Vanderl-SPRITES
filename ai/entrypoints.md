...
| `spell`, `ability`, `action`, `miracle`, `rituos`, `projectile`, `aoe`, `cone`, `touch` | `code/modules/spells/**`, `ai/spell_signal_map.md` | `code/datums/status_effects/**`, `code/datums/components/**`, `code/datums/elements/**`, `modular_rmh/code/modules/spells/**` | `SSmagic`, `SSstatusprocess`, `SSskills` |
| `combat`, `melee`, `attack`, `hit`, `weapon`, `disarm`, `parry`, `block`, `shield`, `projectile` | `ai/combat_signal_map.md`, `code/_onclick/item_attack.dm` | `code/_onclick/other_mobs.dm`, `code/modules/projectiles/projectile.dm`, defense/species files, `modular_rmh/**` | `SSdcs`, mob/projectile paths, AI combat listeners |
| `sex`, `lewd`, `arousal`, `erp`, `kink` | `code/datums/sex/**`, `code/datums/components/arousal.dm` | `code/modules/mob/**`, `modular_rmh/code/datums/ai/horny_ai/**`, `modular_rmh/code/game/objects/items/lewd/**`, `ai/signal_map.md` | `SSobj`, `SSdcs`, mob/chat paths |
...
| `movement`, `move`, `collision`, `pull`, `buckle`, `throw`, `glide`, `moveloop`, `pathing` | `ai/movement_signal_map.md`, `code/modules/mob/mob_movement.dm` | `code/modules/mob/living/living_movement.dm`, `code/controllers/subsystem/movement/**`, `modular_rmh/**` | `SSmovement`, `SSdcs`, mob movement paths |
