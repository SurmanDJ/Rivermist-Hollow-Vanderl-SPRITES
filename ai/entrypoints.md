...
3. Escalate only if needed:
   ...
   - inheritance unclear -> `ai/type_tree.md`
...
| exact BYOND type path like `/datum/...`, `/mob/...`, `/obj/...` | `ai/type_tree.md` | matching DM branch in `code/**` and `modular_rmh/**` | depends on branch |
