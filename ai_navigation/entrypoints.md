...
| `quest`, `questing`, `contract`, `bounty`, `courier`, `retrieval`, `scroll`, `compass` | `code/modules/questing/**` | `code/__DEFINES/quests.dm`, `code/modules/antagonists/villain/harlequinn/bounty.dm`, `modular_rmh/code/modules/jobs/**` | `SSprocessing`, `SStreasury`, `SSmapping` |
