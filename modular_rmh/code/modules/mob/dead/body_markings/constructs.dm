/*
 * Synthetic body markings for metal constructs and dolls.
 */

/datum/body_marking/construct_plating_light
	icon = 'modular_rmh/icons/mob/body_markings/construct_plating.dmi'
	name = "Light Plating"
...
/datum/body_marking/construct_head_standard
	icon = 'modular_rmh/icons/mob/body_markings/construct_heads.dmi'
	name = "Standard Head"
	icon_state = "standard"
...
/datum/body_marking/construct_standard_eyes
	name = "Standard Eyes"
	icon = 'modular_rmh/icons/mob/body_markings/construct_eyes.dmi'
	icon_state = "standard"
	affected_bodyparts = HEAD
	default_color = DEFAULT_SECONDARY
	gendered = FALSE
