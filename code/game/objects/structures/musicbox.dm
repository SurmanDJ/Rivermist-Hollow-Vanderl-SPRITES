...
/obj/structure/fake_machine/musicbox
	...
	desc = "A marvelous device created by dwarven artificers, it plays a variety of songs from across Faience, as if their performers were within the same room."
