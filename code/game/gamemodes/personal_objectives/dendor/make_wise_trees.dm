/datum/objective/personal/wise_trees
	...
	rewards = list("2 Triumphs", "Silvanus grows stronger", "Silvanus blesses you (+1 Fortune)")
...
/datum/objective/personal/wise_trees/complete_objective()
	. = ..()
	to_chat(owner.current, span_greentext("You have created enough wise trees to satisfy Silvanus!"))
...
/datum/objective/personal/wise_trees/update_explanation_text()
	explanation_text = "Transform [trees_required] common trees into guardian wise trees using Silvanus's blessing."
