/datum/objective/personal/mock
	...
	triumph_count = 2
	rewards = list("2 Triumphs", "Tymora grows stronger")
...
/datum/objective/personal/mock/monarch/update_explanation_text()
	. = ..()
	explanation_text = "Viciously mock the monarch for Tymora!"
...
/datum/objective/personal/mock/noble/update_explanation_text()
	. = ..()
	explanation_text = "Viciously mock [required_count] nobles for Tymora!"
