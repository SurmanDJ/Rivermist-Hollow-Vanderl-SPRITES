...
#define HORNY_MOB_TYPE_VOLFS (1 << 4)
#define HORNY_MOB_TYPE_LAMIAS (1 << 5)
#define HORNY_MOB_TYPE_MINOTAURS (1 << 6)
#define HORNY_MOB_TYPE_LYCANS (1 << 7)
#define HORNY_MOB_TYPE_ALL (HORNY_MOB_TYPE_HUMANOIDS | HORNY_MOB_TYPE_SPIDERS | HORNY_MOB_TYPE_BOG_BUGS | HORNY_MOB_TYPE_TROLLS | HORNY_MOB_TYPE_VOLFS | HORNY_MOB_TYPE_LAMIAS | HORNY_MOB_TYPE_MINOTAURS | HORNY_MOB_TYPE_LYCANS)
