GLOBAL_LIST_INIT(automaton_voice_lines, list(
	"Umberlee Praise" = list("text" = "GLORY TO UMBERLEE", "file" = 'sound/vo/automaton/abyssorpraise.ogg'),
	"Against Time" = list("text" = "WE RACE AGAINST TIME", "file" = 'sound/vo/automaton/againsttime.ogg'),
	"Lathander Praise" = list("text" = "PRAISE LATHANDER", "file" = 'sound/vo/automaton/astratapraise.ogg'),
	...
	"Silvanus Praise" = list("text" = "SILVANUS BE PRAISED", "file" = 'sound/vo/automaton/dendorpraise.ogg'),
	...
	"Sune Praise" = list("text" = "SUNE WATCHES OVER US", "file" = 'sound/vo/automaton/eorapraise.ogg'),
	"Sune Praise 2" = list("text" = "IN SUNE'S NAME", "file" = 'sound/vo/automaton/eorapraise2.ogg'),
	...
	"Moradin Praise" = list("text" = "MORADIN BE PRAISED", "file" = 'sound/vo/automaton/malumpraise.ogg'),
	...
	"Jergal Praise" = list("text" = "JERGAL BE PRAISED", "file" = 'sound/vo/automaton/necrapraise.ogg'),
	"No" = list("text" = "NO", "file" = 'sound/vo/automaton/No.ogg'),
	"Mystra Praise" = list("text" = "MYSTRA BE PRAISED", "file" = 'sound/vo/automaton/nocpraise.ogg'),
	...
	"Ilmater Praise" = list("text" = "ILMATER BE PRAISED", "file" = 'sound/vo/automaton/pestrapraise.ogg'),
	"Ao Endures" = list("text" = "AO ENDURES", "file" = 'sound/vo/automaton/PSYDONLIVES.ogg'),
	"Tempus Praise" = list("text" = "TEMPUS BE PRAISED", "file" = 'sound/vo/automaton/ravoxpraise.ogg'),
	...
	"Tymora Praise" = list("text" = "TYMORA BE PRAISED", "file" = 'sound/vo/automaton/xylixpraise.ogg'),
