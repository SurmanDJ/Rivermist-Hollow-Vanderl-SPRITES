...
/datum/coven_power/eora
	name = "Sune power name"
	desc = "Sune power desc"
...
/datum/coven_power/eora/beautys_restoration
	...
	desc = "Channel Sune's power to restore physical beauty and heal disfigurements."
...
/datum/coven_power/eora/beautys_restoration/activate(mob/living/target)
	...
	to_chat(owner, span_notice("You channel Sune's restorative power into [patient]."))
